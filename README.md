...
the "return functtion" inside of PersonalDice
b. Compare and contrast calling `dansRoll` the first and second time. What is always the same? What could change?
The numbers generated change while the wording stays the same
c. What is the lexical scope of `newRoll`?
newRoll shares the "name" variable of its parent function
