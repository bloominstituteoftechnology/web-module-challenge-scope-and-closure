...
/*Task 1: counterMaker()
  ...
  - In counter 1, the variable if local, while in counter 2, the variable is global.
  ...
  3. In what scenario would the counter1 code be preferable? In what scenario would
     counter2 be better?
  - counter1 is preferable if you do not want global variables. counter2 is preferablewhen you do want global variables.   
*/
...
function finalScore(inning, curInning){
  let finalScore = {
    Home: 0,
    Away: 0
  };

   for(let i = 0; i <= curInning; i++) {
     let home = inning()
     let away = inning()
