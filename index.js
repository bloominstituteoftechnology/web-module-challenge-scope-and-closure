...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    - counter1 is using closure and counter2 is using a function to update the value inside of it
  2. Which of the two uses a closure? How can you tell?
    - counter1. It uses the first function to declare the initial count of 0.
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better? 
    - not really sure.  *reminder to ask in class*
*/
