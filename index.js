...
/*Task 1: counterMaker()
  ...
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  In the baseball game, counter1 would work per inning, counter2 works for the total of the entire game
*/
...
function scoreboard(getInningScoreCB, inningCB, numberOfInnings) {
  ...
  if (homeTotal === awayTotal) {
    scoreArray.push(`This game will require extra innings: Away ${awayTotal} - Home ${homeTotal}`);
    return scoreArray;
  } else {
    scoreArray.push(`Final Score: Away ${awayTotal} - Home ${homeTotal}`);
    return scoreArray;
  }
}
