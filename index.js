...
/*Task 1: counterMaker()
  ...
  In counter1 the variable "count" is only accessible within itself. In counter2 the variable "count" is a global variable and accessible everywhere.
  2. Which of the two uses a closure? How can you tell?
  Counter1 uses a closure because it references a function that contains a function.
  3. In what scenario would the counter1 code be preferable?
  -- If you had many individual or specific uses.
  In what scenario would counter2 be better?
  -- If you want one counter to be affected by multiple functions.
*/
