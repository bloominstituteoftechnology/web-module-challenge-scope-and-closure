...
let homeScore=0;
let awayScore=0;
function getInningScore(taskFourCallback) {
  let FourScoreboard={
    Home: homeScore+taskFourCallback(), //need to store the value for future use. Maybe try nesting a function here? Or storing outside?
    Away: awayScore+taskFourCallback()
  }
  return FourScoreboard

  /* attempt 1
  let homeScore=0
  let awayScore=0
  const addInningScore=taskFourCallback(){
    return 
  } */
}
