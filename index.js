...
/*Task 1: counterMaker()
  ...
  counter one is using closure counter2 is not
  1. What is the difference between counter1 and counter2?
  
  2. Which of the two uses a closure? How can you tell?
  counter1. it is bundling two functions together
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     counter1 would be usefull for changing values of multiple different things where counter2 is good for one specific thing
*/
