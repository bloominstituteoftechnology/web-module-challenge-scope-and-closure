...
function scoreboard(inningScore, eachInning, totalInnings) {
  let home = 0;
  let away = 0;
  /* 
  for loop cycles through 9 totalInnings return score for each individual inning
  inningScore(eachInning());
