...
/*Task 1: counterMaker()
  ...
  counter1 has a closure and uses the count var as an internal var instead of a global
  2. Which of the two uses a closure? How can you tell?
  counter1 uses closure. The function returns a funtion.
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?
     counter1 would be more useful if you don't want to make count a global var. count2 is useful if you want to allow count to be accessed by more than that single function.
*/
