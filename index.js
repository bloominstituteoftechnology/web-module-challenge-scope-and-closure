...
/*Task 1: counterMaker()
  ...
  In counter1 the count variable is inside the function. In counter2 it is outside the function. So in the first example the variable is function scoped and in the second the variable is in global scope. 
...
function finalScore(inningCb, numInningsPlayed){
  let homeScore = 0;
  let awayScore = 0;
...
function scoreboard(inningScoreCb, inningCb, numInningsPlayed) {
  const scoreByInning = [];
  let homeScore = 0;
  let awayScore = 0;
