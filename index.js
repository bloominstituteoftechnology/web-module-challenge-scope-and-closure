...
// // counter2 uses closure by grabbing an external variable.


//   2. Which of the two uses a closure? How can you tell?
//   //   counter1 uses closure by having the counter inside it's function. The counter is closed off from the global scope.

//   3. In what scenario would the counter1 code be preferable? In what scenario would counter2 be better?  
//     //  counter1 is preferred when you do not want things outside of the given function to mutate the counter. Other functions can access the global counter2, so if you needed the counter to be mutated by other bit of code outside of the function, then counter2 is preferred.
*/
