...
/*Task 1: counterMaker()
  ...
  Counter 1 has a local variable of count stored, whereas counter2 has a global variable for count stored.
  2. Which of the two uses a closure? How can you tell?
  Counter1 uses a closure. There is a return function inside of the counterMaker function.
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     Counter1 would be preferred if you needed to overwrite the count number each time it was called, since it will always start at 0 when the function is invoked. Counter2 would be preferred if you needed to have a running counter going throughout the entire application. As that variable can be called an used by everything, and it's value will continue to increment each time the function is invoked.
*/
