...
/*Task 1: counterMaker()
  ...
  Counter 1 has closure, because of the function inside of a function calling to a variable in the outer function
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?
     
     In a situation that you would need multiple counters going at the same time it would be better to use fuction 1,
     but funtion two would be better if you needed only one.
*/
